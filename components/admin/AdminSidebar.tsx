...
export default function AdminSidebar({ locale, dict }: Props) {
    const pathname = usePathname();

    const navItems = [
        {
            href: `/${locale}/admin`,
            label: dict.admin.sidebar.dashboard,
            icon: (
        ...
        },
        {
            ...
            label: dict.admin.sidebar.users,
            icon: (
        ...
        <aside className="w-full md:w-64 bg-card border-b md:border-b-0 md:border-r border-border flex flex-col min-h-[auto] md:min-h-screen">
            ...
            <div className="p-4 mt-auto border-t border-border">
                ...
                >
                    ...
                    <span>{dict.admin.sidebar.back}</span>
                </Link>
            </div>
        </aside>
    );
