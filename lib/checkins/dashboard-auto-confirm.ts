 ...
 * triggers a new refresh. Pending always refreshes immediately.
 */
...
export async function dashboardAutoConfirm(userId: string): Promise<CheckinData | null> {
    ...
    //    Mirrors the DB predicate used in the UPDATE below.
    ...
    //         prevents writing if the row was already refreshed between read and write
